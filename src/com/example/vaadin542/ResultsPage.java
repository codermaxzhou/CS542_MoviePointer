...
public class ResultsPage extends ResultsLayout implements ClickListener {
	...
	public ResultsPage(String searchTerm, UI parent) {
        ...
        extOptionGrp3.addItems(new String[] {"director1", "director2", "director3"});
    ...
    public void buttonClick(ClickEvent event) {
        ...
        if(origin.equals(linkYear)) windowContent.addComponent(extOptionGrp1);
        else if(origin.equals(linkGenre)) windowContent.addComponent(extOptionGrp2);
        else if(origin.equals(linkDirector)) windowContent.addComponent(extOptionGrp3);
        else windowContent.addComponent(extOptionGrp4);
